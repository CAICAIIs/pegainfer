...
| `models/qwen35/accuracy.md` | Qwen3.5-4B HF bf16 logits golden through `past_key_values` (`qwen35-4b-hf-golden.safetensors`); exact-text JSON remains regression-only, and cross-arch rand/hash corpus design is deferred. |
