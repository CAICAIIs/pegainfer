...
| `models/qwen35/decode-kernel-attribution.md` | nsys kernel attribution of the remaining serving gap vs vLLM 0.27 on A100: c16 average decode batch ~8 vs 16 (admission waves), bs1 step is 60% host gap (3.9ms kernels + 5.9ms gap), GDN/full-attn decode kernels 2.3-2.6x per layer-step at half batch, two unattributed ~1.5ms/step GEMM shapes; improvement queue ordered. |
